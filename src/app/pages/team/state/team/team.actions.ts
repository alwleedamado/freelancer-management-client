...
import { AddMemberToTeamCommand, TeamMember } from "pages/team/models/team-member";
import { TypedAction } from "@ngrx/store/src/models";

export interface ITeamActions extends IngrxActions<Team> {
    addMember: ActionCreator<string, (props: { teamId: string; teamMember: TeamMember }) => { teamId: string; teamMember: AddMemberToTeamCommand } & TypedAction<string>>,
    ...
    getAllMembers: ActionCreator<string, (props: {teamId: string}) => {teamId: string} & TypedAction<string>>
    getAllMembersSuccess: ActionCreator<string, (props: { payload: TeamMember[] }) => { payload: TeamMember[] } & TypedAction<string>>
    getAllMembersFauiled: ActionCreator<string, (props: { error: any }) => { error: any } & TypedAction<string>>
...
export const actions: ITeamActions = {
    ...
    addMember: createAction(`${prefix} Add New Team Memeber`, props<{ teamId: string; teamMember: AddMemberToTeamCommand }>()),
    addMemberSuccess: createAction(`${prefix} Added New Team Memeber Successufuly`, props<{ payload: TeamMember }>()),
    addMemberFail: createAction(`${prefix} Add New Team Memeber failed`, props<{ error: any }>()),
    ...
    getAllMembers: createAction(`${prefix} load all team members`, props<{teamId: string}>()),
    getAllMembersSuccess: createAction(`${prefix} load all team members success`, props<{ payload: TeamMember[] }>()),
    getAllMembersFauiled: createAction(`${prefix} load all team members failed`, props<{ error: any }>()),
